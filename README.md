...
* [environment-gpu-1.yml](https://github.com/michael-kitchin/CarND-Behavioral-Cloning-P3/blob/master/environments/environment-gpu-1.yml): GPU back end 
* [environment-cpu-1.yml](https://github.com/michael-kitchin/CarND-Behavioral-Cloning-P3/blob/master/environments/environment-cpu-1.yml): CPU back end
...
See: [video.mp4](https://github.com/michael-kitchin/CarND-Behavioral-Cloning-P3/blob/master/video.mp4).

The model provided ([model.h5](https://github.com/michael-kitchin/CarND-Behavioral-Cloning-P3/blob/master/model.h5)) may be used to operate the simulated vehicle indefinitely on the first test track up to the configurable maximum of ~30mph.

This model was generated by the [model.py](https://github.com/michael-kitchin/CarND-Behavioral-Cloning-P3/blob/master/model.py) script, which supports the following arguments:
