...
The model provided ([model.h5](https://github.com/michael-kitchin/CarND-Behavioral-Cloning-P3/blob/master/model.h5)) may be used to operate the simulated vehicle indefinitely on the first test track up to the configured maximum of ~30mph.
